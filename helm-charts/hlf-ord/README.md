...
```bash
$ helm install helm-charts/hlf-ord
```
...
```bash
$ helm install helm-charts/hlf-ord --name ord1
```
...
```bash
$ helm install helm-charts/hlf-ord --name ord1 --set ord.mspID=MyMSP
```

Alternatively, a YAML file can be provided while installing the chart. This file specifies values to override those provided in the default values.yaml. For example,

```bash
$ helm install helm-charts/hlf-ord --name ord1 -f my-values.yaml
```
...
```bash
$ helm upgrade ord1 helm-charts/hlf-ord -f my-values.yaml
```
